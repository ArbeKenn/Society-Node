...
Revision ID: ef53eefa3675
Revises: 4de0297fb7e5
Create Date: 2026-05-25 15:58:39.617762
...
revision: str = 'ef53eefa3675'
down_revision: Union[str, Sequence[str], None] = '4de0297fb7e5'
...
def downgrade() -> None:
    ...
    sa.Column('coin', sa.NUMERIC(), autoincrement=False, nullable=True),
    sa.Column('followers', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('following', sa.INTEGER(), autoincrement=False, nullable=True),
    ...
    sa.ForeignKeyConstraint(['following_id'], ['users.id'], name=op.f('followers_following_id_fkey')),
